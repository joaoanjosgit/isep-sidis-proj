...
public class CancelSubscriptionConsumer {

    private final SubscriptionsDTOMapper subscriptionsDTOMapper;
    private static final Logger logger = LoggerFactory.getLogger(CancelSubscriptionConsumer.class);

    private final SubscriptionsService subscriptionsService;

    @RabbitListener(queues = "#{cancelSubscriptionQueue.name}")
    public void receiveMessage(SubsDTO dto) {
        ...
        subscriptionsService.saveCanceledSubsRabbit(subscription, version);
