...
public class BootstrapRabbitClient {
    ...
    private final UserRepository userRepositoryBD;

    private final SubscriptionsRepositoryBD subscriptionsRepositoryBD;

    public BootstrapRabbitClient(RabbitTemplate rabbitTemplate, PlansRepository repositoryBD, UserRepository userRepositoryBD, SubscriptionsRepositoryBD subscriptionsRepositoryBD) {
